const API_URL = "http://www.omdbapi.com/?i=tt3896198&apikey=5725d838";
const API_URL_SEARCH = "http://www.omdbapi.com/?apikey=5725d838";
...
console.log(search_input.value); const query = search_input.value;
if (query) {
...
function showMovies (movies){
    card.innerHTML="";
    movies.forEach(async function(movie){
    const movieData = await fetch(API_URL_SEARCH+movie.imdbID); const movieDataobj = await movieData.json();
    movie_display(movieDataobj);
    });
